...
const schema = z.object({
  ...
  price: z.number({ invalid_type_error: "Prețul trebuie să fie un număr" }).min(1, "Prețul trebuie să fie mai mare ca 0"),
categoryId: z.number({ invalid_type_error: "Selectează o categorie" }).min(1, "Selectează o categorie"),
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 text-white shadow-lg">
        <div className="max-w-3xl mx-auto px-6 py-5">
          <h1 className="text-2xl font-bold">⚡ TechZone — Adaugă produs</h1>
        </div>
      </header>
